            ...
            {brands.map((b) => (
              <li key={b.slug}>
                <Link
                  ...
                  className="flex items-center justify-between gap-3 px-4 py-4 rounded-xl border border-border bg-surface-2 hover:border-border-strong transition-colors group"
                >
