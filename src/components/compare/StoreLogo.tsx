...
export default function StoreLogo({
  ...
  /* Theme-aware inversion sourced from the shared registry in
     src/lib/store-logo-invert.ts so DupeCard / PriceResults stay
     in lockstep. See that file's comment for the rationale. */
